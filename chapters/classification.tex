...
\todo{SSU slides first slide 5 and mention even empirical risk minimization and second slide 2}
\todo{we can say examples of particular types and cite some articles and even examples of algorithms}
...
\todo{maybe we can mention generative and discriminative learning}
