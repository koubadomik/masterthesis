...
\todo{I think we want to aim only on stastistical machine learning, so let's define it at the beginning} - Statistical learning theory deals with the problem of finding a predictive function based on data.
\todo{do not forget to cite this great web - https://machinelearningmastery.com} \cite{JasonBrownlee2020} in some situation!
...
generalization mistake and definition of different kinds of errors
...
\todo{define, reference - https://machinelearningmastery.com/how-to-choose-loss-functions-when-training-deep-learning-neural-networks/ \cite{JasonBrownlee2020} }
