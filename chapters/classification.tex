...
Before deriving basic metrics, we have to emphasize that all of them have to be treated in a particular context. The most important condition is the overall balance of the dataset - the ratio of positive and negative examples. List of some metrics is in \ref{tab:metrics} \todo{might be in appendix}.
