\chapter{Classifier evaluation metrics} \label{app:metrics}
...
\begin{table}[h]
    ...
    \begin{tabular}{lcp{5cm}}
      ...
      \midrule
      f1 score & $2 \cdot \frac{precision \dot recall}{precision+recall}$ & good measure if we seek for a trade-of between precision and recall, we migh compare more classifiers using it\\
      \bottomrule
    \end{tabular}
    \end{minipage}
    \label{tab:metrics}
