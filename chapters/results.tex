...
The reason might be a spurious correlation you have mentioned in some section (refer) earlier. Without larger data / some methods for causality detection, this might be impossible to discover.
...
\textbf{I would put parts of this to the individual cases and summarizes it again as you did. It might be easier for the reader, as he will see the individual explanations of explanations in the context.}
