...
Good performance of some signatures in this group arouses our interest in the explaining part of those signatures. In cases of \emph{invalidauthenticodesignature} and \emph{packerentropy} explanation we should not take it too seriously due to the performance. Overall the first group has statistically better performance as we expected but this comparison is not relevant so much.
